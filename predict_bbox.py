...
def predidct_age_gender_race(save_prediction_at, bboxes, imgs_path = 'cropped_faces/'):
    ...
    model_fair_7.load_state_dict(torch.load('FairFace/fair_face_models/fairface_alldata_20191111.pt'))
...
if __name__ == "__main__":
    ...
    SAVE_DETECTED_AT = "Aux_Files_Face/Detected_Faces"
    ...
    predidct_age_gender_race("Aux_Files_Face/RAG_outputs.csv", bboxes, SAVE_DETECTED_AT)

def boxes(imgs):
    SAVE_DETECTED_AT = "Aux_Files_Face/Detected_Faces"
    return detect_face(imgs, SAVE_DETECTED_AT)

def prediction(bboxes):
    SAVE_DETECTED_AT = "Aux_Files_Face/Detected_Faces"
    return predidct_age_gender_race("Aux_Files_Face/RAG_outputs.csv", bboxes, SAVE_DETECTED_AT)
